        ...
        <Col xs={12} md={8} className="box1">
            <Card className="sections">
              ...
              <p className="pb-3 card-text">
                I'm Stanco and I'm in my final year at Arizon State University (ASU). As a software engineer, I'm dedicated to enhancing my resume
                with projects. 
                </p>
              <p className="pb-4 card-text">
              When I'm not coding, you will probably find me gaming or shooting some hoops on the basketball court.
              I'm eager to transition into the professional tech world and make a significant impact.
                </p>
            </Card>
        </Col>
